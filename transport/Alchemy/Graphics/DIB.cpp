...
ALERROR dibLoadFromBlock (IReadBlock &Data, HBITMAP *rethDIB)
...
ALERROR dibLoadFromFile (CString sFilename, HBITMAP *rethDIB)
...
//	Loads a DIB into memory
	...
	return dibLoadFromBlock(DIBFile, rethDIB);
	}

ALERROR dibLoadFromResource (HINSTANCE hInst, char *szResource, HBITMAP *rethDIB)
...
//	Loads a DIB from a resource
	...
	return dibLoadFromBlock(Data, rethDIB);
	}
