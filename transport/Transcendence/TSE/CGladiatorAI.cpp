...
//	Fly, fight, die
	...
	switch (m_State)
		...
		case stateAttackingTarget:
			...
			int iFireDir;
			ImplementFireWeaponOnTarget(-1, -1, m_pTarget, vTarget, rTargetDist2, &iFireDir);
...
CSpaceObject *CGladiatorAI::GetTarget (void)
...
//	Handle the case where another object is destroyed
	...
	switch (m_State)
		...
		//	cancelled and we will be called at OnOrderChanged.
